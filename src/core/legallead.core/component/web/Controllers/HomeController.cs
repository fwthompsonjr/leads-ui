...
namespace legallead.web.reader.Controllers
{
    public class HomeController : Controller
    {
        ...
        private static string GetIndex()
        {
            ...
            {
                "Read inbound search queues",
                "Process search results",
                "Log error and statuses",
            };
            ...
            content.AppendLine("     legallead: web reader");
            content.AppendLine("   </div>");
            content.AppendLine("   <div>");
            content.AppendLine("     <h2Permissions Api</h2>");
            content.AppendLine("     <blockquote>");
            content.AppendLine("      The legallead.web.reader is a component used to manage search interactions from <br/>");
            content.AppendLine("      all users and applications in the leadlead applications suite.");
            content.AppendLine("     </blockquote>");
            content.AppendLine("   </div>");
            content.AppendLine("   <div>");
