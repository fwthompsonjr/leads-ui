...
{
    public class ProfileChangedTemplate : HtmlTransformDetailBase
    {
        ...
        private static readonly string HtmlBase = Properties.Resources.email_template_html_body_profile_change;
