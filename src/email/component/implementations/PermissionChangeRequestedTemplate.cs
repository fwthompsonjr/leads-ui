...
{
    public class PermissionChangeRequestedTemplate : HtmlTransformDetailBase
    {
        ...
        private static readonly string HtmlBase = Properties.Resources.email_template_html_body_permission_request;
