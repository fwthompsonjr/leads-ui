...
{
    public class PermissionChangeRequestedTemplateTests
    {
        [Fact]
        public void SutCanBeCreated()
        {
            var exception = Record.Exception(() => { _ = new PermissionChangeRequestedTemplate(); });
        ...
        public void SutHasBaseHtml()
        {
            ...
            {
                var service = new PermissionChangeRequestedTemplate();
                _ = service.BaseHtml;
            });
            Assert.Null(exception);
        }
