...
{
    public class LockedAccountResponseTemplateTests
    {
        [Fact]
        public void SutCanBeCreated()
        {
            var exception = Record.Exception(() => { _ = new LockedAccountResponseTemplate(); });
        ...
        public void SutHasBaseHtml()
        {
            ...
            {
                var service = new LockedAccountResponseTemplate();
                _ = service.BaseHtml;
            });
            Assert.Null(exception);
        }
