...
{
    public class BaseEmailActionTemplateTests : IDisposable
    {
        public BaseEmailActionTemplateTests()
        {
        ...
        public void ProviderCanGetResultExecutingFiler(string payload)
        {
            var exception = Record.Exception(() =>
            {
                ...
                var controller = provider.GetService<BaseEmailActionTemplate>();
        ...
        private static FilterContext GetContext(string result, bool isExecuted = true)
        {
            ...
            collection.AddTransient<BaseEmailActionTemplate>();
            collection.AddMvcCore(o =>
            {
                o.Filters.AddService<BaseEmailActionTemplate>();
            });
        ...
        {
            [HttpGet]
            [ServiceFilter(typeof(BaseEmailActionTemplate))] // Apply the filter to this action method
