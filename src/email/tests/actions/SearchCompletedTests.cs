...
{
    public class SearchCompletedTests : IDisposable
    {
        public SearchCompletedTests()
        {
        ...
        public void ProviderCanGetResultExecutingFiler(string payload)
        {
            var exception = Record.Exception(() =>
            {
                ...
                var controller = provider.GetService<SearchCompleted>();
        ...
        private static FilterContext GetContext(string result, bool isExecuted = true)
        {
            ...
            collection.AddTransient<SearchCompleted>();
            collection.AddMvcCore(o =>
            {
                o.Filters.AddService<SearchCompleted>();
            });
        ...
        {
            [HttpGet]
            [ServiceFilter(typeof(SearchCompleted))] // Apply the filter to this action method
