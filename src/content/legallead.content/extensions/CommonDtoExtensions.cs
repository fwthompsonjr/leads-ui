...
{
    internal static class CommonDtoExtensions
    {
        public static Dapper.DynamicParameters SelectParameters(this CommonBaseDto obj, CommonBaseDto? predicate = null)
        {
        ...
        public static Dapper.DynamicParameters UpdateParameters(this CommonBaseDto obj)
        {
            var parms = new Dapper.DynamicParameters();
        ...
        public static Dapper.DynamicParameters InsertParameters(this CommonBaseDto obj)
        {
            var parms = new Dapper.DynamicParameters();
        ...
        public static string UpdateByIdSQL<T>(this T obj, T? predicate = null, bool mySqlFormat = false) where T : CommonBaseDto
        {
        ...
        public static string DeleteSQL(this CommonBaseDto obj, bool mySqlFormat = false)
        {
        ...
        public static Dapper.DynamicParameters DeleteParameters(this CommonBaseDto obj)
        {
            var parms = new Dapper.DynamicParameters();
