...
{
    internal class SearchTargetDto : BaseDto
    {
        ...
        public override object? this[string field]
        {
            get
            {
                ...
                if (fieldName.Equals("Component", Comparison)) return Component;
            ...
            set
            {
                ...
                if (fieldName.Equals("Component", Comparison))
                {
                    Component = ChangeType<string>(value);
                    return;
                }
